# Generated by Powerlevel10k configuration wizard on 2019-09-05 at 12:34 PDT.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 65183.
# Wizard options: awesome-fontconfig, small icons, classic, light, time, flat tails,
# 2 lines, solid, no frame, sparse, many icons, fluent.
